...
/*!
  \struct StatisticT
  \All Statistic data for display information
 */
struct StatisticT {
	std::string team_left_stats_;
	std::string team_right_stats_;
	std::string player_left_stats_;
	std::string player_right_stats_;
	std::string left_interception_;
	std::string left_foul_;
	std::string left_tackle_;
	std::string left_goal_;
	std::string left_yellow_card_;
	std::string left_red_card_;
	std::string right_interception_;
	std::string right_foul_;
	std::string right_tackle_;
	std::string right_goal_;
	std::string right_yellow_card_;
	std::string right_red_card_;
