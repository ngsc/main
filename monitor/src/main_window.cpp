 ...
 */
void
MonitorMainWindow::readSettings()
{
    QSettings settings( Options::CONF_FILE,
                        QSettings::IniFormat );

    settings.beginGroup( "MonitorMainWindow" );
 ...
 */
void
MonitorMainWindow::writeSettings()
{
    QSettings settings( Options::CONF_FILE,
                        QSettings::IniFormat );
 ...
 */
void
MonitorMainWindow::createActions()
{
    createActionsFile();
 ...
 */
void
MonitorMainWindow::createActionsFile()
{
    //
 ...
 */
void
MonitorMainWindow::createActionsMonitor()
{
    //
 ...
 */
void
MonitorMainWindow::createActionsReferee()
{
    // kick off
 ...
 */
void
MonitorMainWindow::createActionsView()
{
    // menu bar
 ...
 */
void
MonitorMainWindow::createActionsHelp()
{
 ...
 */
void
MonitorMainWindow::createMenuFile()
{
 ...
 */
void
MonitorMainWindow::createMenuMonitor()
{
 ...
 */
void
MonitorMainWindow::createMenuReferee()
{
 ...
 */
void
MonitorMainWindow::createMenuView()
{
 ...
 */
void
MonitorMainWindow::createMenuHelp()
{
 ...
 */
void
MonitorMainWindow::createToolBars()
{
 ...
 */
void
MonitorMainWindow::createStatusBar()
{
 ...
 */
void
MonitorMainWindow::createFieldCanvas()
{
 ...
 */
void
MonitorMainWindow::createConfigDialog()
{
    if ( M_config_dialog )
    {
        return;
 ...
 */
void
MonitorMainWindow::closeEvent( QCloseEvent * event )
{
    event->ignore();
 ...
 */
void
MonitorMainWindow::printShortcutKeys()
{
 ...
 */
void
MonitorMainWindow::setQuitTimer()
{
 ...
 */
void
MonitorMainWindow::disconnectMonitor()
{
    if ( M_monitor_client )
    {
 ...
 */
void
MonitorMainWindow::reconnectMonitor()
{
    //std::cerr << "MonitorMainWindow::reconnectMonitor()" << std::endl;
    if ( M_monitor_client )
    {
        disconnectMonitor();
 ...
 */
void
MonitorMainWindow::toggleMenuBar( bool checked )
{
 ...
 */
void
MonitorMainWindow::toggleStatusBar( bool checked )
{
 ...
 */
void
MonitorMainWindow::changeStyle( bool checked )
{
    if ( ! checked )
    {
        return;
 ...
 */
void
MonitorMainWindow::toggleFullScreen()
{
...
*/
void
MonitorMainWindow::showPlayerTypeDialog()
{
    if ( M_player_type_dialog )
    {
 ...
 */
void
MonitorMainWindow::showConfigDialog()
{
 ...
 */
void
MonitorMainWindow::setFocusPoint( const QPoint & point )
{
 ...
 */
void
MonitorMainWindow::dropBall( const QPoint & point )
{
    {
 ...
 */
void
MonitorMainWindow::freeKickLeft( const QPoint & point )
{
    if ( M_monitor_client
         && M_monitor_client->isConnected() )
    {
 ...
 */
void
MonitorMainWindow::freeKickRight( const QPoint & point )
{
    if ( M_monitor_client
         && M_monitor_client->isConnected() )
    {
 ...
 */
void
MonitorMainWindow::yellowCard( const char side,
                        const int unum )
{
    if ( M_monitor_client
         && M_monitor_client->isConnected() )
 ...
 */
void
MonitorMainWindow::redCard( const char side,
                     const int unum )
{
    if ( M_monitor_client
         && M_monitor_client->isConnected() )
 ...
 */
void
MonitorMainWindow::changePlayMode( int mode )
{
 ...
 */
void
MonitorMainWindow::receiveMonitorPacket()
{
    if ( Options::instance().bufferingMode() )
    {
 ...
 */
void
MonitorMainWindow::resizeCanvas( const QSize & size )
{
    if ( centralWidget() )
    {
        if ( this->isMaximized()
 ...
 */
void
MonitorMainWindow::updatePositionLabel( const QPoint & point )
{
 ...
 */
void
MonitorMainWindow::updateBufferingLabel()
{
 ...
 */
void
MonitorMainWindow::showRecoveringState()
{
