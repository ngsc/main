...
ConfigDialog::createColorItems()
{
	...
	M_color_list_box->addItem( new ColorItem( tr( "Field" ),
                                              o->fieldBrush().color(),
                                              std::bind( std::mem_fn( &Options::setFieldColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Line" ),
                                              o->linePen().color(),
                                              std::bind( std::mem_fn( &Options::setLineColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Score Board Font" ),
                                              o->scoreBoardPen().color(),
                                              std::bind( std::mem_fn( &Options::setScoreBoardPenColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Score Board Background" ),
                                              o->scoreBoardBrush().color(),
                                              std::bind( std::mem_fn( &Options::setScoreBoardBrushColor ), o, std::placeholders::_1 ) ) );

    M_color_list_box->addItem( new ColorItem( tr( "Ball" ),
                                              o->ballPen().color(),
                                              std::bind( std::mem_fn( &Options::setBallColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Ball Velocity" ),
                                              o->ballVelPen().color(),
                                              std::bind( std::mem_fn( &Options::setBallVelColor ), o, std::placeholders::_1 ) ) );

    M_color_list_box->addItem( new ColorItem( tr( "Player Pen" ),
                                              o->playerPen().color(),
                                              std::bind( std::mem_fn( &Options::setPlayerPenColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Left Team" ),
                                              o->leftTeamPen().color(),
                                              std::bind( std::mem_fn( &Options::setLeftTeamColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Left Goalie" ),
                                              o->leftGoaliePen().color(),
                                              std::bind( std::mem_fn( &Options::setLeftGoalieColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Right Team" ),
                                              o->rightTeamPen().color(),
                                              std::bind( std::mem_fn( &Options::setRightTeamColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Right Goalie" ),
                                              o->rightGoaliePen().color(),
                                              std::bind( std::mem_fn( &Options::setRightGoalieColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Player Number" ),
                                              o->playerNumberPen().color(),
                                              std::bind( std::mem_fn( &Options::setPlayerNumberColor ), o, std::placeholders::_1 ) ) );
//     M_color_list_box->addItem( new ColorItem( tr( "Player Number (Interior)" ),
//                                               o->playerNumberInnerPen().color(),
//                                               std::bind( std::mem_fn( &Options::setPlayerNumberInnerColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Neck" ),
                                              o->neckPen().color(),
                                              std::bind( std::mem_fn( &Options::setNeckColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "View Area" ),
                                              o->viewAreaPen().color(),
                                              std::bind( std::mem_fn( &Options::setViewAreaColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Large View Area" ),
                                              o->largeViewAreaPen().color(),
                                              std::bind( std::mem_fn( &Options::setLargeViewAreaColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Ball Collision" ),
                                              o->ballCollideBrush().color(),
                                              std::bind( std::mem_fn( &Options::setBallCollideColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Player Collision" ),
                                              o->playerCollideBrush().color(),
                                              std::bind( std::mem_fn( &Options::setPlayerCollideColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Effort Decayed" ),
                                              o->effortDecayedPen().color(),
                                              std::bind( std::mem_fn( &Options::setEffortDecayedColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Recovery Decayed" ),
                                              o->recoveryDecayedPen().color(),
                                              std::bind( std::mem_fn( &Options::setRecoveryDecayedColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Kick" ),
                                              o->kickPen().color(),
                                              std::bind( std::mem_fn( &Options::setKickColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Kick Fault" ),
                                              o->kickFaultBrush().color(),
                                              std::bind( std::mem_fn( &Options::setKickFaultColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Kick Acceleration" ),
                                              o->kickAccelPen().color(),
                                              std::bind( std::mem_fn( &Options::setKickAccelColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Catch" ),
                                              o->catchBrush().color(),
                                              std::bind( std::mem_fn( &Options::setCatchColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Catch Fault" ),
                                              o->catchFaultBrush().color(),
                                              std::bind( std::mem_fn( &Options::setCatchFaultColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Tackle" ),
                                              o->tacklePen().color(),
                                              std::bind( std::mem_fn( &Options::setTackleColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Tackle Fault" ),
                                              o->tackleFaultBrush().color(),
                                              std::bind( std::mem_fn( &Options::setTackleFaultColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Foul Charged" ),
                                              o->foulChargedBrush().color(),
                                              std::bind( std::mem_fn( &Options::setFoulChargedColor ), o, std::placeholders::_1 ) ) );
    M_color_list_box->addItem( new ColorItem( tr( "Pointto" ),
                                              o->pointtoPen().color(),
                                              std::bind( std::mem_fn( &Options::setPointtoColor ), o, std::placeholders::_1 ) ) );
}
...
ConfigDialog::createFontButtons()
{
    ...
    Options * o = &Options::instance();
    {
        FontButton * btn = new FontButton( tr( "Score Board" ),
                                           o->scoreBoardFont(),
                                           std::bind( std::mem_fn( &Options::setScoreBoardFont ), o, std::placeholders::_1 ),
                                           this );
    ...
    }
    {
        FontButton * btn = new FontButton( tr( "Player" ),
                                           o->playerFont(),
                                           std::bind( std::mem_fun( &Options::setPlayerFont ), o, std::placeholders::_1 ),
                                           this );
        layout->addWidget( btn, 0, Qt::AlignLeft );
    }
    {
        FontButton * btn = new FontButton( tr( "Measure" ),
                                           o->measureFont(),
                                           std::bind( std::mem_fun( &Options::setMeasureFont ), o, std::placeholders::_1 ),
                                           this );
        layout->addWidget( btn, 0, Qt::AlignLeft );
    }
