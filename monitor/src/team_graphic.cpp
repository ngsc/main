...
TeamGraphic::XpmTile::print( std::ostream & os ) const
{
    ...
    const std::vector< std::shared_ptr< std::string > >::const_iterator cend
        = colors().end();
    for ( std::vector< std::shared_ptr< std::string > >::const_iterator it
              = colors().begin();
          it != cend;
          ++it )
    {
...
//                       << std::endl;
    ...
    const std::vector< std::shared_ptr< std::string > >::iterator color_end = M_colors.end();

    for ( std::vector< std::shared_ptr< std::string > >::iterator color = M_colors.begin();
          color != color_end;
          ++color )
    {
