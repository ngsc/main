...
Rectangle
{
    ...
    function setClub() {
        app_title_bar.title = managerUser.clubName;
        app_title_bar.selectedclubname = qsTr("League %1").arg(managerUser.club.leagueId === 0 ? "A" : "B")
    ...
    Rectangle{
        ...
        Rectangle{
            ...
            Rectangle{
                ...
                radius: 5
                gradient:Gradient {
                    GradientStop { position: 0.0; color: "#8b8bf1" }
                    GradientStop { position: 0.50; color: "#6c6cf3" }
                    GradientStop { position: 1.0; color: "#1a3a82" }
                }
                Text{
                    id :goelitext
                    anchors.horizontalCenter: parent.horizontalCenter
        ...
        Rectangle{
            ...
            Rectangle{
                ...
                radius: 5
                gradient: Gradient {
                    GradientStop { position: 0.0; color: "#71ed57" }
                    GradientStop { position: 0.50; color: "#55da3a" }
                    GradientStop { position: 1.0; color: "#2c821a" }
                }
                Text{
                    id :midfieldertext
                    anchors.horizontalCenter: parent.horizontalCenter
        ...
        Rectangle{
            ...
            Rectangle{
                ...
                radius: 5
                gradient: Gradient {
                    GradientStop { position: 0.0; color: "#f65454" }
                    GradientStop { position: 0.50; color: "#f81a1a" }
                    GradientStop { position: 1.0; color: "#9e0c0c" }
                }
                Text{
                    id :attackertext
                    anchors.horizontalCenter: parent.horizontalCenter
